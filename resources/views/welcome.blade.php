...
@section('content')
	@include('layouts.search')
	 ...
	 <div class="row">
        <div class="col-lg-3 col-md-3">
              ...
              <center>
                <img class="img-responsive img-thumbnail" src="{{ asset('images/projects/test4.png') }}">
                <img class="img-responsive img-thumbnail" src="{{ asset('images/projects/laundry.jpg') }}">
              </center>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3">
                              <center>
                  <img class="img-responsive img-thumbnail" src="{{ asset('images/projects/test2.png') }}">
                  <img class="img-responsive img-thumbnail" src="{{ asset('images/projects/test.png') }}">
                </center>
                            <div align="center">
                <span class="label label-primary" data-toggle="tooltip" title=""><i class="fa fa-eye"></i> 003</span>
                <span class="label label-success" data-toggle="tooltip" title=""><i class="fa fa-bookmark-o"></i> 001</span>
